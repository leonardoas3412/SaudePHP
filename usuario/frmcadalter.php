...
<?php
  ...
  if(isset($_GET['cod'])){
    ...
    $sql = "select * from tbusu where cod_usu = $cod";
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-wrapper">
            ...
            <div class="page-header" id="topfrm">                
                  <h1 class="pageheader-title">Alteração de Contatos</h1>
            </div>                
                ...
                <div class="card">                                
                    <div class="card-body">
                      <form name="form1" method="POST" action="update.php" onsubmit="return validar()">
                         <input type="hidden" name="cod" value="<?php echo $linha['cod_usu']; ?>">
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    <label for="validationCustom01">Nome</label>
                                    <input class="form-control" type="text" name="nome" id="nome" placeholder="" value="<?php echo $linha['nome'];?>" required>                                            
                                </div>
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    <label for="validationCustom01">Email</label>
                                    <input name="email" type="text" class="form-control"placeholder=""value="<?php echo $linha['email']; ?>" required>                                            
                                </div>                                        
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    <label for="validationCustom01">Senha</label>
                                    <input name="senha" type="text" class="form-control"placeholder="" value="<?php echo $linha['senha']; ?>" required>                                             
                                </div>                                      
