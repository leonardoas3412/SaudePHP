    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-wrapper">
            ...
            <div class="page-header" id="topfrm">                
                  <h1 class="pageheader-title">Busca de paciente</h1>
            </div>
                                                    ...
                                                    if($consulta == true){
                                                        ...
                                                        while($linha = $consulta->fetch_array(MYSQLI_ASSOC)){
                                                            echo '<tr>
                                                                    ...
                                                                    <td>'.$linha['sexo'].'</td> 
                                                                    <td>
                                                                        <a title="alterar"onclick="validaralter('.$linha['cod_pac'].')" class="btn btn-info"><i class="fa fa-edit"></i>
                                                                        <a title="delete" onclick="validardelete('.$linha['cod_pac'].')" class="btn btn-danger"><i class="fa fa-trash"></i>
                                                                    </td>
                                                                    </tr>';
                                                            } 
                                                        }
