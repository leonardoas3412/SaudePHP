...
<?php
  ...
  if(isset($_GET['cod'])){
    ...
    $sql = "select * from tbcliente where cod_pac = $cod";
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-wrapper">
            ...
            <div class="page-header" id="topfrm">                
                  <h1 class="pageheader-title">Alteração de paciente</h1>
            </div>                
                ...
                <div class="card">                                
                    <div class="card-body">
                      <form name="form1" method="POST" action="update.php" onsubmit="return validar()">
                         <input type="hidden" name="cod" value="<?php echo $linha['cod_pac']; ?>">
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    <label for="validationCustom01">Nome</label>
                                    <input name="nome" type="text" class="form-control"value="<?php echo $linha['nome']; ?>"required>                                             
                                </div>
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    <label for="validationCustom01">cpf</label>
                                    <input name="cpf" type="text" class="form-control" value="<?php echo $linha['cpf']; ?>"required>                                              
                                </div>                                        
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    <label for="validationCustom01">endereco</label>
                                    <input name="endereco" type="text" class="form-control"value="<?php echo $linha['endereco']; ?>"required>                                              
                                </div>  
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    <label for="validationCustom01">fone</label>
                                    <input name="fone" type="text" class="form-control"value="<?php echo $linha['fone']; ?>"required>                                              
                                </div>
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    <label for="validationCustom01">nascimento</label>
                                    <input name="nascimento"  type="text" class="form-control"value="<?php echo $linha['nascimento']; ?>"required>                                             
                                </div>
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    <label for="validationCustom01">Email</label>
                                    <input name="email" type="text" class="form-control" value="<?php echo $linha['email']; ?>"required>                                              
                                </div>                                        
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    <label for="validationCustom01">cns</label>
                                    <input name="cns" type="text" class="form-control" value="<?php echo $linha['cns']; ?>"required>                                              
                                </div>  
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    <label for="validationCustom01">sexo</label>
                                    <input name="sexo" type="text" class="form-control"value="<?php echo $linha['sexo']; ?>"required>                                              
                                </div>                                     
