...
<?php
  ...
  if(isset($_GET['cod'])){
    ...
    $sql = "select * from tbprocedimento where cod_proced = $cod";
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-wrapper">
            ...
            <div class="page-header" id="topfrm">                
                  <h1 class="pageheader-title">Alteração de procedimento</h1>
            </div>                
                ...
                <div class="card">                                
                    <div class="card-body">
                      <form name="form1" method="POST" action="update.php" onsubmit="return validar()">
                         <input type="hidden" name="cod" value="<?php echo $linha['cod_proced']; ?>">
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
