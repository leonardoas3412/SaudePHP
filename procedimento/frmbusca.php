    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-wrapper">
            ...
            <div class="page-header" id="topfrm">                
                  <h1 class="pageheader-title">Busca de procedimento</h1>
            </div>
                                        ...
                                        <thead>
                                            ...
                                            <tbody>
                                                ...
                                                if(isset($_POST['texto'])) {
                                                    ...
                                                    $sql="select * from tbprocedimento where nome like '%$texto%'";
                                                    ...
                                                    if($consulta == true){
                                                        ...
                                                        while($linha = $consulta->fetch_array(MYSQLI_ASSOC)){
                                                            echo '<tr>
                                                                    <td>'.$linha['cod_proced'].'</td>
                                                                    <td>'.$linha['nome'].'</td>
                                                                    <td>
                                                                        <a title="alterar"onclick="validaralter('.$linha['cod_proced'].')" class="btn btn-info"><i class="fa fa-edit"></i>
                                                                        <a title="delete" onclick="validardelete('.$linha['cod_proced'].')" class="btn btn-danger"><i class="fa fa-trash"></i>
                                                                    </td>
                                                                    </tr>';
                                                            } 
                                                        }
