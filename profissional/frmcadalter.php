...
<?php
  ...
  if(isset($_GET['cod'])){
    ...
    $sql = "select * from tbprofissional where cod_prof = $cod";
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-wrapper">
            ...
            <div class="page-header" id="topfrm">                
                  <h1 class="pageheader-title">Alteração de profissional</h1>
            </div>                
                ...
                <div class="card">                                
                    <div class="card-body">
                      <form name="form1" method="POST" action="update.php" onsubmit="return validar()">
                         <input type="hidden" name="cod" value="<?php echo $linha['cod_prof']; ?>">
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    <label for="validationCustom01">crm</label>
                                    <input name="crm" type="text" class="form-control" value="<?php echo $linha['crm']; ?>"required>                                              
                                </div>  
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    <label for="validationCustom01">area</label>
                                    <input name="area" type="text" class="form-control" value="<?php echo $linha['area']; ?>"required>                                              
                                </div>
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
