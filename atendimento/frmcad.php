    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-wrapper">
            ...
            <div class="page-header" id="topfrm">                
                  <h1 class="pageheader-title">Cadastro de atendimento</h1>
            </div> 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                <label for="validationCustom01">Codigo paciente</label>
																<select class="form-control" name="cod_pac">
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
												...
												<select class="form-control" name="cod_prof">
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                <label for="validationCustom01">Codigo procedimento</label>
															<select class="form-control" name="cod_proced">
